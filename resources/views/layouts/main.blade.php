                    ...
                    <div class="tab-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="panel" style="cursor: pointer;">
                                        ...
                                        <div class="due-date text-center pull-right">{{date('d')}}<br>{{date('F')}}</div>
                                            <div class="checkbox checkbox-primary ">
                                                <input name="isCompleted" class="todo-done"  id="1" type="checkbox">
                                                <label for="1"></label>
                                            </div>
                                        </div>
                        ...
                        <div id="managetasks" class="tab-pane fade">
                            <div class="row m-b-20 new-button">
                                <div class="col-md-12">
                                    <div class="pull-right">
                                    <a type="button" href="{{route('admin.task.create')}}" class="btn btn-primary waves-effect waves-light new-task-btn"><i class="fa fa-plus"></i> Add New Task</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Created Tasks -->
                        ...
                        <div id="completedtasks" class="tab-pane fade">
                                ...
                                <div class="col-md-12">
                                    <div class="pull-right">
                                        ...
                                        <ul class="dropdown-menu" role="menu" style="right: 30px;">
                                            <li><a href="{{ route('admin.export') }}">PDF</a></li>
                                            <li><a href="{{ route('admin.export') }}">Excel CSV</a></li>
                                        </ul>
                                    <a type="button" href=""class="btn btn-default waves-effect waves-light"> Delete All</a>
                            ...
                            <div class="row completed-blocks">
                                   ...
                                   @if(!empty($taskscomp)&&count($taskscomp)>0)
                                   @foreach($taskscomp as $value)
                                <div class="col-sm-6 col-md-4">
                                    <div class="panel" style="cursor: pointer;">
                                        <div class="panel-header">
                                            <div class="due-date text-center pull-right">{{date('d')}}<br>{{date('F')}}</div>
                                        ...
                                        <div class="panel-footer" style="padding: 0;text-align: right;">
                                            <div class="icon-links quick-icon-links">
                                                    <form action="{{route('admin.task.destroy',$value)}}"  method="post">
                                                            @csrf
                                                            @method('delete')
                                                            <button data-toggle="tooltip" type="submit" id="" title="Delete" class="btn btn icon-btn">
